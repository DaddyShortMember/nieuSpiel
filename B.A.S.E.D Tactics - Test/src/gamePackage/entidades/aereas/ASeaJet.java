...
public class ASeaJet implements Tropa{
	//ATRIBUTOS LÃ“GICOS
	ListaIDTropa idTropa = ListaIDTropa.A_SEAJET;
	...
	//Constructor
	public ASeaJet(Point pos, String imagen) {
		super();
		this.pos = pos;
		this.imagen = imagen;
	}
	...
	public String toString() {
		return "ASeaJet [idTropa=" + idTropa + ", tipoTropa=" + tipoTropa + ", tipoMov=" + tipoMov + ", captura="
