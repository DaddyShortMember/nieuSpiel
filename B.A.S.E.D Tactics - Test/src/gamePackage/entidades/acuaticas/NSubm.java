...
public class NSubm implements Tropa{
	//ATRIBUTOS LÃ“GICOS
	ListaIDTropa idTropa = ListaIDTropa.N_SUBM;
	ListaTipos tipoTropa = ListaTipos.SUBMARINA;
	...
	int golpePrim = 120;
	int golpeSec = 200;
	ListaArmas armaPrincipal = ListaArmas.TORPEDO;
	...
	//Constructor
	public NSubm(Point pos, String imagen) {
		super();
		this.pos = pos;
		this.imagen = imagen;
	}
	...
	public String toString() {
		return "NSubm [idTropa=" + idTropa + ", tipoTropa=" + tipoTropa + ", tipoMov=" + tipoMov + ", captura="
