...
public class NCarr implements Tropa{
	//ATRIBUTOS LÃ“GICOS
	ListaIDTropa idTropa = ListaIDTropa.N_CARR;
	...
	ListaArmas armaSecundaria = ListaArmas.ARMA_AA;
	int precio = 20000;
	int nivel = 0;
	int vision = 0;
	int alcanceMin = 0;
	...
	public String toString() {
		return "NCarr [idTropa=" + idTropa + ", tipoTropa=" + tipoTropa + ", tipoMov=" + tipoMov + ", captura="
