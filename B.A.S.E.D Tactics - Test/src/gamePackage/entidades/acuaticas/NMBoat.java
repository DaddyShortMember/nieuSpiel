...
public class NMBoat implements Tropa{
	//ATRIBUTOS LÃ“GICOS
	ListaIDTropa idTropa = ListaIDTropa.N_MBOAT;
	...
	//ATRIBUTOS FÃ�SICOS
	String nombre = "Buque de Misiles";
	Point pos = new Point(0,0); //Posicion
	String imagen = ""; //DirecciÃ³n de imagen
	
	//Constructor
	public NMBoat(Point pos, String imagen) {
		super();
		this.pos = pos;
		this.imagen = imagen;
	}
	...
	public String toString() {
		return "NMBoat [idTropa=" + idTropa + ", tipoTropa=" + tipoTropa + ", tipoMov=" + tipoMov + ", captura="
